<%-- 
    Document   : themnguoi
    Created on : May 27, 2026, 1:41:30 AM
    Author     : LENOVO
--%>
    ...
    <body>
        <div class="form-card page-enter">
            ...
            <div class="form-body">
                ...
                <form action="themnguoi" method="POST">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="password" name="password" class="form-control" required placeholder="Nhập mật khẩu...">
                    </div>
